...
public class Point implements Comparable<Point> {
    ...
    private class SlopeOrder implements Comparator<Point> {
        ...
        public int compare(Point q, Point r) {
            return Double.compare(given.slopeTo(q), given.slopeTo(r));
        }
    }
    ...
    public Comparator<Point> slopeOrder() {
        // Point point = this;
        // Comparator<Point> comparator = (a, b) -> Double.compare(point.slopeTo(a), point.slopeTo(b));
        // return comparator;
        SlopeOrder slopeOrder = new SlopeOrder(this);
        return slopeOrder;
    }
